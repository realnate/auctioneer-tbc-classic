...
function private.MakeGuiConfig()
	...
	if not gui.SetBackdropColor then Mixin(gui, BackdropTemplateMixin) end
	...
	if not gui.frame.progressbar.SetBackdrop then Mixin(gui.frame.progressbar, BackdropTemplateMixin) end
